...
//	/**
//	 * 現在のIDのログインが自分であるかを確認
//	 * 		※1アカウント1ユーザとする為
//	 * @return	自分であればtrue
//	 */
//	public static boolean checkOneUserLogin(Context context){
//		Log.e("###   普天間ログ   ###","  Util.checkOneUserLogin  ");
//
//
//		String ip = getMyIPv4ForVPN();
//		if(ip.equals("")){
//			ip = getMyIPv4ForWifi();
//		}
//
//
//		// HTTP 通信開始
//		String url = "https://" + MainService.getSipServerIp() + "/address/callcheck.php";
//		String[] keys	= {"sip_id","ip_address"};
//		String[] values	= {PortSipConfig.getLoginInfo(MainService.mContext, PortSipConfig.LOGIN_SUCCESS_SIP_NAME),
//						   ip};
//		tmpString = JsonControl.doPost(url, keys, values, MainService.mContext);
//
//
//		if(tmpString == null){
//			// メッセージを表示
//			MainActivity.displayMessage(context.getApplicationContext(), "サーバへ接続できませんでした");
//			return false;
//		}
//		else if(tmpString.contains("1")){
//			return true;
//		}else{
//			// メッセージを表示
//			MainActivity.displayMessage(context.getApplicationContext(), "他の端末からログインした形跡がございます\nアプリを再起動し、再度ログインしてください");
//			return false;
//		}
//	}
