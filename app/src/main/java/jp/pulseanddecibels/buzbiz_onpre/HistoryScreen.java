...
public class HistoryScreen {
	...
	public HistoryScreen(Context context, MyFrameLayout myFrameLayout) {
		...
		// 履歴リストを設定
		ListView historyList = (ListView)myFrameLayout.findViewById(R.id.history_list);
                    ...
                    MainActivity.getHandler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (((Activity) context).isFinishing() == false) {
                                ...
                                HistoryListAdapter baseAdapter = new HistoryListAdapter(context, parcedArray, R.layout.history_list_item);
                                ListView listView = (ListView) ((Activity) context).findViewById(R.id.history_list);
