...
public class IncomingCallAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		((ImageButton) view.findViewById(R.id.answer_button)).setOnClickListener(answer);


		// 表示名を設定
		((TextView) view.findViewById(R.id.incoming_call_label)).setText(item.getDisplayInfo());
