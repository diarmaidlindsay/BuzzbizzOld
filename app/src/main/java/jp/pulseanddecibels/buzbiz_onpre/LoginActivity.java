...
import jp.pulseanddecibels.buzbiz_onpre.models.WifiController;
...
public class LoginActivity
    ...
    @InjectView(R.id.btn_end_application)
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.login_screen);            // ビューを設定
