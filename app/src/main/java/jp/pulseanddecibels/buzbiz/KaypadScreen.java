...
//		Log.e(Util.LOG_TAG,"  キーパッド画面.コンストラクタ  ");
		...
		// 各キーパッドのボタンを設定
		myFrameLayout.findViewById(jp.pulseanddecibels.buzbiz.R.id.num_one_button)		.setOnClickListener(kaypadClickListener);
		myFrameLayout.findViewById(jp.pulseanddecibels.buzbiz.R.id.num_two_button)		.setOnClickListener(kaypadClickListener);
		myFrameLayout.findViewById(jp.pulseanddecibels.buzbiz.R.id.num_three_button)	.setOnClickListener(kaypadClickListener);
		myFrameLayout.findViewById(jp.pulseanddecibels.buzbiz.R.id.num_four_button)	.setOnClickListener(kaypadClickListener);
		myFrameLayout.findViewById(jp.pulseanddecibels.buzbiz.R.id.num_five_button)	.setOnClickListener(kaypadClickListener);
		myFrameLayout.findViewById(jp.pulseanddecibels.buzbiz.R.id.num_six_button)		.setOnClickListener(kaypadClickListener);
		myFrameLayout.findViewById(jp.pulseanddecibels.buzbiz.R.id.num_seven_button)	.setOnClickListener(kaypadClickListener);
		myFrameLayout.findViewById(jp.pulseanddecibels.buzbiz.R.id.num_eight_button)	.setOnClickListener(kaypadClickListener);
		myFrameLayout.findViewById(jp.pulseanddecibels.buzbiz.R.id.num_nine_button)	.setOnClickListener(kaypadClickListener);
		myFrameLayout.findViewById(jp.pulseanddecibels.buzbiz.R.id.num_zero_button)	.setOnClickListener(kaypadClickListener);
		myFrameLayout.findViewById(jp.pulseanddecibels.buzbiz.R.id.num_kome_button)	.setOnClickListener(kaypadClickListener);
		myFrameLayout.findViewById(jp.pulseanddecibels.buzbiz.R.id.num_sharp_button)	.setOnClickListener(kaypadClickListener);
...
//		}else if(MainService.curentKaypadScreen == MainService.CALLING_NO_KAYPUD){
		}else if(MainService.curentKaypadScreen == MainService.KeyPadStates.CALLING_NO_KAYPUD){
			KaypadScreen.startUseingUiMuteAndSpeakerButton();
			setCallScreen();
//		}else if(MainService.curentKaypadScreen == MainService.CALLING_KAYPUD){
		}else if(MainService.curentKaypadScreen == MainService.KeyPadStates.CALLING_KAYPAD){
			KaypadScreen.startUseingUiMuteAndSpeakerButton();
...
//			Log.e(Util.LOG_TAG,"  キーパッド画面.callingHoldClickListener  ");
	...
	private final OnClickListener callingHungUpClickListener = new OnClickListener(){
		@Override
		public void onClick(View view) {
			Log.e("KeypadScreen", "  キーパッド画面.callingHungUpClickListener  ");
			view.setClickable(false);

			Log.e("KeypadScreen", "1");

			// 切断
			MainService.LIB_OP.endCall();
			Log.e("KeypadScreen", "2");
			stopTimer();
			Log.e("KeypadScreen", "3");

			view.setClickable(true);
			Log.e("KeypadScreen", "4");
		}
	};
...
//		MainService.curentKaypadScreen = MainService.NOMAL;
		MainService.curentKaypadScreen = MainService.KeyPadStates.NOMAL;
...
//		MainService.curentKaypadScreen = MainService.CALLING_KAYPUD;
		MainService.curentKaypadScreen = MainService.KeyPadStates.CALLING_KAYPAD;
