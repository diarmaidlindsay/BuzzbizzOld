...
//			Log.e(Util.LOG_TAG,"  ExternalTelListAdapter.getView  ");
		...
		// 背景を設定する、
		((ViewGroup) view.findViewById(jp.pulseanddecibels.buzbiz.R.id.list_body_layout)).setBackgroundResource(jp.pulseanddecibels.buzbiz.R.drawable.image_list_cell);


		// リストの表示部分にお客様名を設定
		((TextView) view.findViewById(jp.pulseanddecibels.buzbiz.R.id.tel_list_name)).setText(item.getCustomerName());
