...
//		Log.e(Util.LOG_TAG,"  CharSerchLayout.コンストラクタ  ");
		...
		// ビューをインフレート
		LayoutInflater.from(context).inflate(jp.pulseanddecibels.buzbiz.R.layout.char_serch_layout, this);
...
//			Log.e(Util.LOG_TAG,"  CharSerchLayout.charSerchLayoutOnTouchListener  ");
			...
			if(myLayoutHeight == 0){
				...
				myLayoutHeight = findViewById(jp.pulseanddecibels.buzbiz.R.id.external_char_serch).getHeight();
